 ...
 * @author sakulambo
 */
public class Bullet2  extends ShapeObj {
     private int power;
    private Tank2 owner;

    public Bullet2(Tank2 owner, double x, double y, double vx, double vy, double angle, Color color, boolean visible) {
    ...
    public Tank2 getOwner() {
        return owner;
    }

    public void setOwner(Tank2 owner) {
        this.owner = owner;
    }
